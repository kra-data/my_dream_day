...
// 탭 컴포넌트들 import
import AdminWorkshiftView from '@/views/admin/AdminWorkshiftView.vue'
import AdminDashboardView from '@/views/admin/AdminDashboardView.vue'
import AdminEmployeeView from '@/views/admin/AdminEmployeeView.vue'
...
import ReviewAlert from '@/components/common/alarm/ReviewAlert.vue'
  ...
  data() {
    return {
      ...
      tabs: [
        ...
        { id: 'payroll', name: '급여 관리', icon: 'money', component: 'AdminPayrollView' },
...
<style scoped>
@import '@/assets/styles/views/admin/AdminView.css';
</style>