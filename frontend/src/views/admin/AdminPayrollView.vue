...
import EmployeeSettlementModal from '@/components/AdminPayrollView/AdminEmployeeSettlementModal.vue'
import SettlementCompletedModal from '@/components/AdminPayrollView/AdminSettlementCompletedModal.vue'

export default {
  name: 'AdminPayrollView',
  components: {
    AppIcon,
    EmployeeSettlementModal,
    SettlementCompletedModal
...
<style scoped src="@/assets/styles/views/admin/AdminPayrollView.css"></style>
